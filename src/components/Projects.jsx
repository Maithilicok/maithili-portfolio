...
export default function Projects({ onNavigateAllProjects }) {
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      description: "A full-stack RAG engine enabling instant natural-language Q&A over PDF documents using Gemini AI & Qdrant vector database.",
      ...
      glowHover: "hover:shadow-[0_0_60px_-5px_rgba(16,185,129,0.55)] hover:border-emerald-500/70"
    },
    {
      id: "spiel",
      name: "Spiel",
